...
namespace ProcurementManager.Controllers
{
    public class ParametersController : Controller
    {
        ...
        public async Task<IActionResult> Edit([FromBody]ContractParameters parameters)
        {
            ...
            return Created($"/Parameters/Find?id={parameters.ContractParametersID}", new { parameters.Amount, parameters.Concurrency, parameters.ContractParameter, parameters.ContractParametersID, parameters.ContractsID, parameters.ExpectedDate, parameters.IsCompleted, parameters.Percentage });
        }
